...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.title_plainTextEdit.setEnabled(False)
        self.title_plainTextEdit.setMaximumSize(QSize(16777215, 30))
        ...
        self.company_plainTextEdit.setEnabled(False)
        self.company_plainTextEdit.setMaximumSize(QSize(16777215, 30))
        ...
        self.location_plainTextEdit.setEnabled(False)
        self.location_plainTextEdit.setMaximumSize(QSize(16777215, 30))
        ...
        self.postedAt_plainTextEdit.setEnabled(False)
        self.postedAt_plainTextEdit.setMaximumSize(QSize(16777215, 30))
        ...
        self.salary_plainTextEdit.setEnabled(False)
        self.salary_plainTextEdit.setMaximumSize(QSize(16777215, 30))
        ...
        self.remote_plainTextEdit.setEnabled(False)
        self.remote_plainTextEdit.setMaximumSize(QSize(16777215, 30))
        ...
        self.description_plainTextEdit.setEnabled(False)
        sizePolicy1 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.description_plainTextEdit.sizePolicy().hasHeightForWidth())
        self.description_plainTextEdit.setSizePolicy(sizePolicy1)
        ...
        self.qualifications_plainTextEdit.setEnabled(False)
        sizePolicy1.setHeightForWidth(self.qualifications_plainTextEdit.sizePolicy().hasHeightForWidth())
        self.qualifications_plainTextEdit.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.links_plainTextEdit.sizePolicy().hasHeightForWidth())
        self.links_plainTextEdit.setSizePolicy(sizePolicy1)
        ...
        sizePolicy2.setHeightForWidth(self.filter_plainTextEdit.sizePolicy().hasHeightForWidth())
        self.filter_plainTextEdit.setSizePolicy(sizePolicy2)
        ...
        sizePolicy3.setHeightForWidth(self.filter_pushButton.sizePolicy().hasHeightForWidth())
        self.filter_pushButton.setSizePolicy(sizePolicy3)
